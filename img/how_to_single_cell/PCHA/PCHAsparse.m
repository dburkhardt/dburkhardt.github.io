...
% Fixed 8/10-2018 \sum_(X)_ij>0 to \sum_(X)_ij~=0 on line 11 in the
% description of the model
% Updated 9/10-2018 to handle when noc is specified as 1 (sum(*) changed to sum(*,1) in code)
% Updated 1/11-2018 to fix issue in which XC was not also sorted according
%                   to component importance
